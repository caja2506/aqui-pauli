...
export const ORDER_STATUS_COLORS = {
  ...
  preparando: { bg: 'bg-rose-100', text: 'text-rose-700', border: 'border-rose-200' },
  enviado: { bg: 'bg-rose-100', text: 'text-rose-700', border: 'border-rose-200' },
...
export const CRM_FUNNEL_STAGES = [
  ...
  { key: 'recurrente', label: 'Recurrente', color: 'rose' },
